...
import {Text, Image, View, ScrollView, ImageBackground,Button} from 'react-native';
...
class WhatToDo extends Component<Props> {
                ...
                <ImageBackground source={require('../Backgrounds/theme-header.png')} style={{width: '100%', height:90}}>
                    <View style={{position: 'absolute', left: 0, bottom: 0}}>
                        <View style={{
                            ...
                            <Text style={{fontWeight:'bold',fontSize:25,color:'white',marginLeft:'4%'}}>{"What To Do"}</Text>
                        </View>
                    </View>
                </ImageBackground>
                    ...
                    return (
                        <Card key={mapingData.id}>
                            <CardItem button onPress={() => {
                                ...
                                <Button
                                    style={{borderRadius:10,borderWidth: 1, borderColor: '#fff'}}
...
export default withNavigation(WhatToDo);